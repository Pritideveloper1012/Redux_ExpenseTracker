...
const LandingPage = () => {
  ...
  const handleSubmit = (e) => {
    ...
    dispatch(updateCategoricalBudget({ food: foodBudget, travel: travelBudget, entertainment: entertainmentBudget, others }));
  ...
  return (
    <div className="landing-page">
      ...
      <form name="landing-page-form" onSubmit={handleSubmit}>
        ...
        <input placeholder="Total Budget" type="number" value={totalBudget} onChange={(e) => setTotalBudget(e.target.value)} />
        <input placeholder="Food" type="number" value={food} onChange={(e) => setFood(e.target.value)} />
        <input placeholder="Travel" type="number" value={travel} onChange={(e) => setTravel(e.target.value)} />
        <input placeholder="Entertainment" type="number" value={entertainment} onChange={(e) => setEntertainment(e.target.value)} />
        <button id="new-update" type="submit">New/Update tracker</button>
      </form>
      <button id="clear" onClick={() => window.location.reload()}>Start new tracker</button>
    </div>
  );
};
